...
export default function PackageSlider() {
  ...
  const handleDeployClick = (plan: any) => {
  ...
  return (
    <div className="glass rounded-3xl p-5 sm:p-6 relative">
      {selectedPlan && (
        <PuzzleModal
        ...
        <div ref={trackRef} className="flex gap-3 overflow-x-auto pb-2 px-1 snap-x scroll-smooth">
          {plans.map((plan) => {
            ...
            return (
              <div
                key={plan.name}
                className="snap-start shrink-0 w-[165px] rounded-2xl border border-[#e6e6eb] bg-white p-4 hover:border-[#5b5bd6]/40 hover:shadow-sm transition-all group flex flex-col justify-between"
              >
                <div>
